...
![image-20200422202057799](../images/image-20200422202057799.png)

위와 같은 구조로 템플릿태그를 직접 커스텀하여 만들 수 있다.   

   

**21- 장고만으로 댓글 쓰기 구현**   

django.contrib.humanize 를 통해서 naturaltime 사용!   

![image-20200426121204198](../images/image-20200426121204198.png)

   

기존의 forms 활용을 반복하면서 댓글쓰기 구현함.   
